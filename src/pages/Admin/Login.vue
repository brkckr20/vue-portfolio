    ...
    <div class="font-poppins flex flex-col items-center justify-center h-screen bg-main">
        ...
        <form class="w-[300px]">
            <div class="mt-10">
                ...
                <input type="text" class="w-full h-10 border-b border-black bg-transparent outline-none">
            </div>
            <div class="mt-8">
                <label class="block">Şifre</label>
                <input type="password" class="w-full h-10 border-b border-black bg-transparent outline-none">
            </div>
